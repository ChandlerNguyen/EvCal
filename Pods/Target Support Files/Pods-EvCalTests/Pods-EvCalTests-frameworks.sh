...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-EvCalTests/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'CupertinoYankee.framework'
  install_framework 'EDColor.framework'
  install_framework 'JPSimulatorHacks.framework'
  install_framework 'MSCellAccessory.framework'
